...
$sentencia = $base_de_datos->prepare("INSERT INTO zapatos_vendidos(id_zapato, id_venta, cantidad) VALUES (?, ?, ?);");
$sentenciaExistencia = $base_de_datos->prepare("UPDATE zapatos SET precio = precio - ? WHERE id = ?;");
