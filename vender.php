...
<div class="col-xs-12">
	...
	<form method="post" action="agregarAlCarrito.php">
		<label for="id_zapato">Código de barras:</label>
		<input autocomplete="off" autofocus class="form-control" name="id_zapato" required type="text" id="id_zapato" placeholder="Escribe el código">
	</form>
	<br><br>
